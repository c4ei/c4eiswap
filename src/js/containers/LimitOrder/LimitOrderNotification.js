  ...
  return (
    <div className="limit-order-notification theme__background-12">
      <div className="limit-order-notification__text">
        {props.translate('limit_order.free_fee') || 'No fee for Limit Order (10 LOs per day) If you hold 2000 CEIK in your wallet'}
      </div>
      <div className="limit-order-notification__button" onClick={goToSwap}>
        {props.translate('limit_order.hold_knc') || 'Hold 2000 CEIK now'}
      </div>
    </div>
  )
};
